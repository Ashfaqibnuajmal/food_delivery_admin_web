...
import 'package:user_app/features/due_payment/presentation/widget/due_payment_screen/due_payment_header.dart';
import 'package:user_app/features/due_payment/presentation/widget/due_payment_screen/due_payment_table_container.dart';
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const DuePaymentHeader(title: "Due Users"),
